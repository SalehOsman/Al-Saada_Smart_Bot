...
- **FR-034**: System MUST validate Egyptian phone number format during join request submission and reject invalid formats. Valid format: 11 digits, starting with one of the following operator prefixes:
  ...
  Regex: `/^(010|011|012|015)\d{8}$/`. Validation is handled by `@al-saada/validators` package ([egyptianPhoneNumber()](cci:1://file:///f:/_Al-Saada_Smart_Bot/packages/validators/src/phone.ts:4:0-22:1) function). Error message must be shown in Arabic.
